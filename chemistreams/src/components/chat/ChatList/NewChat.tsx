...
export default function NewChat({ text, onChange } : NewChatProps) {
    ...
    return (
        <div className="md:w-full md:h-[10%] md:flex md:flex-row md:items-center">
            <input value={text} onChange={handleChange} placeholder="Add new chat" className={`md:w-4/5 md:h-1/2 md:rounded-3xl md:px-3 font-jbm ${text === "" ? "text-light-grey" : "text-dark-white"} bg-dark-grey outline-none`} />
