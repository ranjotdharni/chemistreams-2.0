...
export default function PublicNavbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 bg-black border-b border-dark-grey fixed pr-30 w-full h-[10vh] p-2 flex flex-row justify-between items-center">
            <a href={PAGE_LANDING} className="hover:cursor-pointer h-full flex flex-row items-center space-x-2 p-1">
                <div className="h-5 w-15">
                    <AnimatedLogo />
                </div>
                <p className="text-green font-lato text-4xl">ChemiStreams</p>
            </a>

            <div className="text-lg space-x-15">
